...
public class StartWindow {
	...
	public StartWindow(myApplet applet)  {
		...
		cp5.addButton("OnePlayer")
			...
			.setPosition( (myApplet.width-250)/2, myApplet.height-290)
			.setSize(250,50);
		cp5.addButton("TwoPlayer")
			.setLabel("T w o  P l a y e r")
			.setPosition( (myApplet.width-250)/2, myApplet.height-220)
			.setSize(250,50);
		cp5.addButton("MultiPlayer")
			.setLabel("M u l t i   P l a y e r")
			.setPosition( (myApplet.width-250)/2, myApplet.height-150)
			.setSize(250,50);
	...
	public void display(){	
		...
		cp5.getController("MultiPlayer").show();
		this.parent.redraw();
	}
